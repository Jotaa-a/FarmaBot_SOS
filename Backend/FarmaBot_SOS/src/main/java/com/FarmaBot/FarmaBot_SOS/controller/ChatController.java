...
public class ChatController {
    ...
    @Operation(summary = "Requiere los sintomas del paciente", description = "Hace la consulta al modelo  IA basandose en los sintomas del paciente")
    @PostMapping("/chat")
    public ResponseEntity<ChatResponse> caht (@RequestBody ChatRequest request){
        ...
        var productos = qdrantService.buscarSimilares(request.mensaje(), 3);
        var respuesta = triageService.generarRespuestaComercial(productos);
